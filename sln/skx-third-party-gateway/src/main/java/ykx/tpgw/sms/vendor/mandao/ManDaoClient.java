package ykx.tpgw.sms.vendor.mandao;
...
public class ManDaoClient implements ISmsClient {
	...
	private String sn = "SDK-BBX-010-21783";// 序列号
	private String password = "d[98ef[7";
	 ...
	 * 值：注册结果（String）
	 */
	private String register(String province, String city, String trade,
	 ...
	 */
	private String chargeFee(String cardno, String cardpwd) {
		String result = "";
	 ...
	 */
	private String mt(String mobile, String content, String ext, String stime,
			String rrid) {
		String result = "";
	 ...
	 * 值：唯一标识，如果不填写rrid将返回系统生成的
	 */
	private String gxmt(String mobile, String content, String ext, String stime,
			String rrid) {
		String result = "";
	 ...
	 */
	private String UDPPwd(String newPwd) {
		String result = "";
	...
	public SmsSendingResult send(String mobile, String content) {
		...
		try {
			...
			sr.setResultFromVendor(result);
			sr.setResult(!(result.startsWith("-") || result.equals("")));
			return sr; 
		} catch (Exception e) {
			e.printStackTrace();
			sr.setResultFromVendor(e.getMessage());
			sr.setResult(false);
			return sr; 
		}
	}
