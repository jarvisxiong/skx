...
// ID偏移组合生成最终的ID，并返回ID
    ...
    public String getUinqStr() {
        return new M2N().getUniqStr(nextId() + "");
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 100; i++) {
           //rs.add(w.getUinqStr());
            System.out.println(w.getUinqStr());
        }
    ...
    static class M2N {
        // 在这里对输入赋值
        private String Shang = null;
        private int    M     = 10;
        private int    N     = 36;

        public String getUniqStr(String MValue) {
            String nValue = "";
            Shang = MValue;
        ...
        public String qiuyu(String MTempValue) {
            Shang = "";
            int temp = 0;
        ...
        public String getStrFromInt(int value) {
            String result = null;
            if (value >= 0 && value <= 9)
